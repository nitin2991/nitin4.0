...
TELEGRAM_TOKEN = '8327361905:AAF1m5E1-lT66_fV8V9pBSsIETEq20aF8to'


ADMIN_IDS = {7924876437}
...
async def server(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        await msg.edit_text("✅ Attack successfully! Power By @Nitin_710")
    except Exception:
        pass
